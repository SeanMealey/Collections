...
public class MemoryManager {
    ...
    /**
     * She says read this file and understand everything
    ...
    public HashObject insert(String id, String sequence, int length)
        ...
        //I added this here, not sure why but it was causing an error without initializing it
        int counter = 0;

        HashObject hashObjectNew = new HashObject(memID, memFull, counter);
